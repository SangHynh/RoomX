...
const LoginForm = () => {
  ...
  return (
    <div className="relative z-10 bg-white shadow-lg w-full max-w-6xl min-h-[600px] flex">
      {/* Left side */}
      <div className="w-1/2 bg-[url('/src/assets/img/login_bg.jpg')] bg-cover relative flex items-center justify-center">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center px-12">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">{t("button_dang_nhap")}</h2>
